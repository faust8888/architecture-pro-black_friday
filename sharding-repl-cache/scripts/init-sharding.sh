...
echo "=========================================="
echo "Initializing MongoDB Sharding Cluster with Replication and Redis Cache"
echo "=========================================="
...
rs.initiate({
  ...
  configsvr: true,
  members: [
    { _id: 0, host: "cache-configSrv1:27017" },
    { _id: 1, host: "cache-configSrv2:27017" },
    { _id: 2, host: "cache-configSrv3:27017" }
  ]
});
EOF
...
rs.initiate({
  _id: "shard1ReplSet",
  members: [
    { _id: 0, host: "cache-shard1-1:27018", priority: 2 },
    { _id: 1, host: "cache-shard1-2:27018", priority: 1 },
    { _id: 2, host: "cache-shard1-3:27018", priority: 1 }
  ]
});
EOF
...
rs.initiate({
  _id: "shard2ReplSet",
  members: [
    { _id: 0, host: "cache-shard2-1:27019", priority: 2 },
    { _id: 1, host: "cache-shard2-2:27019", priority: 1 },
    { _id: 2, host: "cache-shard2-3:27019", priority: 1 }
  ]
});
EOF
...
sh.addShard("shard1ReplSet/cache-shard1-1:27018,cache-shard1-2:27018,cache-shard1-3:27018");
sh.addShard("shard2ReplSet/cache-shard2-1:27019,cache-shard2-2:27019,cache-shard2-3:27019");
EOF
...
echo ""
echo "Summary:"
echo "- Config Servers: 3 replicas (cache-configSrv1, cache-configSrv2, cache-configSrv3)"
echo "- Shard 1: 3 replicas (cache-shard1-1, cache-shard1-2, cache-shard1-3)"
echo "- Shard 2: 3 replicas (cache-shard2-1, cache-shard2-2, cache-shard2-3)"
echo "- Redis: cache-redis"
echo "- Total: 9 MongoDB instances + 1 mongos router + 1 Redis"